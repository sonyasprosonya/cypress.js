...
describe('Тестирование формы логина Staya', function () {
    ...
    it('Позитивный кейс: верные логин и пароль', function () {
        ...
        cy.get('#__layout > div > main > div > div > div > section > div > form > input:nth-child(1)').type('ТУТ ДОЛЖНА БЫТЬ ВЕРНАЯ ПОЧТА');
        cy.get('#__layout > div > main > div > div > div > section > div > form > input:nth-child(2)').type('ТУТ ДОЛЖЕН БЫТЬ ВЕРНЫЙ ПАРОЛЬ');
    ...
    it('Негативный кейс: верный логин и неверный пароль', function () {
        ...
        cy.get('#stickyHeader > section.header-bottom.transition-header > div > div > a').click();
        cy.get('#__layout > div > main > div > div > div > section > div > form > input:nth-child(1)').type('ТУТ ДОЛЖНА БЫТЬ ВЕРНАЯ ПОЧТА');
        cy.get('#__layout > div > main > div > div > div > section > div > form > input:nth-child(2)').type('ТУТ ДОЛЖЕН БЫТЬ НЕВЕРНЫЙ ПАРОЛЬ');
        cy.get('#__layout > div > main > div > div > div > section > div > form > button > span').click();
